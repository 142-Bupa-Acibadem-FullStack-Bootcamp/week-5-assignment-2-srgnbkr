...
namespace NorthwindProject.DataAccessLayer.Concrete.EntityFramework.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IEntityRepository<T> GetRepository<T>() where T : EntityBase
        {
            return new EntityRepositoryBase<T>(context);
        }
